...
class VideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video" do
    assert_difference('Video.count') do
      post videos_url, params: { video: { name: @video.name, video_data: @video.video_data } }
    end
  ...
  test "should update video" do
    patch video_url(@video), params: { video: { name: @video.name, video_data: @video.video_data } }
